<template>
    <div class="flex flex-row items-left mb-3 py-5 w-full justify-between">
        <div class="flex flex-row gap-3 justify-start items-center">
            <font-awesome-icon :icon="['far', 'circle-left']" size="2xl" class="text-secondary cursor-pointer" title="atras"/>
            <h1>Atras</h1>
        </div>
        <div class="flex flex-row gap-3 justify-start items-center">
    ...
    <!-- <div class="flex-grow flex flex-col items-center justify-start w-6/12">
        <router-view></router-view>
    </div> -->
</template>
